...
### 5. 工作前未读MEMORY.md
**问题**: 每次干活前没有读MEMORY.md
**违规**: CLAUDE.md规定"说'继续X'→先查MEMORY.md"，但没有规定所有任务前都要读
**根因**: self_check没有要求工作前必须读MEMORY.md，只有"继续X"才触发
**解决**: 
1. 更新02_self_check.md，增加"⑥工作前读MEMORY.md"
2. 或者CLAUDE.md明确"任何任务开始前先读MEMORY.md最新状态"
**状态**: ✅ 已整改（02_self_check.md已更新）